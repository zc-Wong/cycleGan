...
parser.add_argument("--x_test_data_path", default='./dataset/infrared2rgbs/testA/', help="path of x test datas.") # x域的测试图片路径
parser.add_argument("--y_test_data_path", default='./dataset/infrared2rgb/testB/', help="path of y test datas.") #y域的测试图片路径
