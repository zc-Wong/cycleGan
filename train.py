...
parser.add_argument("--x_train_data_path", default='./dataset/infrared2rgb/trainA/', help="path of x training datas.") #x域的训练图片路径
parser.add_argument("--y_train_data_path", default='./dataset/infrared2rgb/trainB/', help="path of y training datas.") #y域的训练图片路径
